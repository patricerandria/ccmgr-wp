 ...
 function meris_get_default_slider(){
	...
	// $title = meris_options_array('meris_slide_title_'.$i);
	 ...
	 if(isset($image) && strlen($image)>10){
		 $controller   .= '<li data-target="#carousel-meris-generic" data-slide-to="'.($i-1).'" class="'.$active.'"></li>';
		...
		<div class="metabox-holder">
	    	<div class="postbox">
	    		<h3><?php esc_attr_e( 'Quick Links', 'meris' ); ?></h3>
      			<div class="inside"> 
		          <ul>
                   <li><a href="<?php echo esc_url( 'http://www.mageewp.com/meris-theme.html' ); ?>" target="_blank">Upgrade to Pro</a></li>
